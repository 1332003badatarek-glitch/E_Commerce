...
class _FilesApiService implements FilesApiService {
  _FilesApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<ImageUploadResponse> uploadFile(File file) async {
    ...
    final _options = _setStreamType<ImageUploadResponse>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
